...
- (void)drawView{
    ...
    belowLineView.backgroundColor = MAIN_COLOR;
    ...
    aboveLineView.backgroundColor = MAIN_COLOR;
    ...
    midButton.frame = CGRectMake(self.bounds.size.width/2 - 40, 2, 80, 28);
    [midButton setTitle:@"选择地区" forState:UIControlStateNormal];
    [midButton setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    [self.toolView addSubview:midButton];
    
    
    UIButton *sureButton = [UIButton buttonWithType:UIButtonTypeCustom];
    sureButton.frame = CGRectMake(self.bounds.size.width - 50, 2, 40, 28);
    [sureButton setTitle:@"确认" forState:UIControlStateNormal];
    [sureButton setTitleColor:MAIN_COLOR forState:UIControlStateNormal];
